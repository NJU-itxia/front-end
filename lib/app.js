 ...
 */
let knightList = [
  { "username": "test1", "password": "123456", "email": "123@qq.com", "name": "qixin", "campus": "gulou", "role": "itxia"},
  { "username": "test2", "password": "123456", "email": "123@qq.com", "name": "james", "campus": "xianlin", "role": "itxia"},
  { "username": "test3", "password": "123456", "email": "123@qq.com", "name": "curry", "campus": "gulou", "role": "itxia"}
]
...
app.post('/setting/delete.json', function (req, res) {
  if(req.body.username) {
    knightList = knightList.filter( entry => entry.username != req.body.username);
    res.send({
      "ok": true,
    });
  } else {
